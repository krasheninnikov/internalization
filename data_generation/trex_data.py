...
def generate_triplets_json(
    out_folder="datasets/t-rex-data",
    orig_data_folder="datasets/t-rex-data/original-dataset",
):
...
def make_filtered_triplets_json():
    ...
    for triplet in triplets_list:
        if (
            triplet["subj"] not in single_occurrence_subj
...
def make_trex_qa_dataset(
    seed=0,
    predicates=None,
    min_predicates_per_subj=4,
    max_predicates_per_subj=100,
    max_ents=6000,
):
