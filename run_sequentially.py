...
folder_suffix = 'synth-data-gpt-neo-2.7B'
folder_suffix = 'synth-data-gpt-neo-125M'
dataset_name = 'synth'
...
for seed in range(100, 100 + n_seeds):
    ...
    part3 = f"--num_train_epochs {num_train_epochs} --define_experiment True --adafactor --overwrite_output_dir --auto_find_batch_size True --append_insights_to_qs False"
